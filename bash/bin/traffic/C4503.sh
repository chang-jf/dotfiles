...
echo "================================================================================"
echo "en"
echo "copy $IOS_LOCATION$IOS_NAME tftp:tftp://10.7.6.143/cat4500e-ipbase-mz.122-54.SG1.bin"
#echo "$TFTP_HOST"
#echo "$BACKUP_IOS_NAME"
echo "copy nvram:startup-config tftp://10.7.6.143/C4503_startup-config"
#echo "$TFTP_HOST"
#echo "C4503_startup-config"
echo "copy cat4000_flash:vlan.dat tftp://10.7.6.143/C4503_vlan.dat"
#echo "$TFTP_HOST"
#echo "C4503_vlan.dat"
echo "sh tech-support | redirect tftp://10.7.6.143/C4503_TechSupport.txt"
echo "quit"
echo "================================================================================"
...
if md5sum --status -c $BACKUP_IOS_NAME.md5sum; then
    ...
    sudo touch $TFTP_DIR/C4503_TechSupport.txt && sudo chmod 777 $TFTP_DIR/C4503_TechSupport.txt && sudo chown nobody $TFTP_DIR/C4503_TechSupport.txt
else
